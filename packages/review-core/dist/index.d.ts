...
interface ReviewStore {
    ...
    setCurrentRevision(workspaceId: string, revisionId: string, source: ReviewSource, repository?: ReviewRepository, 
    ...
    analysisPolicy?: AnalysisPolicy): void;
