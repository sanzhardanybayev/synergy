...
export type ReviewRouteKind = 'bundle' | 'progress' | 'questions' | 'active' | 'stream';
...
const ROUTE_SUFFIXES: Record<string, ReviewRouteKind> = Object.assign(Object.create(null), {
  progress: 'progress',
  questions: 'questions',
  active: 'active',
  stream: 'stream',
