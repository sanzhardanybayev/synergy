...
The shared skill owns capture, scope guidance, repository-aware local-key analysis, exact line
coverage, runtime-authoritative review URLs, and the durable browser-question loop. Follow it
exactly; do not reproduce that workflow in this command.
